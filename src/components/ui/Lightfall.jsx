...
// Lightfall — WebGL falling-light-streaks background (React Bits, ogl).
// Used as the Special-mode background in the orbital hub. Bare component only:
// no demo navbar / overlay text — just the canvas.
...
const Lightfall = ({
  ...
  // thrash and risk hitting the browser's max-context limit.
  useEffect(() => {
